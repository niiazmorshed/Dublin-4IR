...
export default function OurWorks() {
  return (
    ...
    >
      <div
        aria-hidden
        className="pointer-events-none absolute top-0 left-1/2 -z-10 h-[420px] w-[min(100%,760px)] -translate-x-1/2 rounded-full bg-[radial-gradient(ellipse,rgba(51,187,207,0.16)_0%,transparent_70%)] blur-3xl"
      />
      ...
      <div className="text-center">
        <div className="section-eyebrow mb-4 rounded-full border border-[var(--border-soft)] bg-[var(--surface-tint)] py-1.5 pr-3.5 pl-2.5 shadow-[var(--shadow-card)] backdrop-blur-[10px]">
          <span className="grid h-5 w-5 place-items-center rounded-md bg-[var(--gradient-icon)] text-[10px] font-extrabold text-white">
            ◆
          </span>
          Our Works
        </div>
